...
hitters = pd.read_csv('Hitters2023August.csv').rename(columns={'PlayerId':'playerid'})
...
pitchers = pd.read_csv('Pitchers2023August.csv').rename(columns={'PlayerId':'playerid'})
