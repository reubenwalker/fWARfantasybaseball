...
owners = pd.read_csv('Draft and Forget 2023 - Sheet1.csv')
owners = owners[['PlayerId', 'Owner']].rename(columns={'PlayerId':'playerid'})
hitters = pd.read_csv('Hitters2023.csv').rename(columns={'PlayerId':'playerid'})
...
pitchers = pd.read_csv('Pitchers2023.csv').rename(columns={'PlayerId':'playerid'})
